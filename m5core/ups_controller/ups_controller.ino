/*******************************************************************************
UPS VRLA Batteries Controller for M5Stack Core
********************************************************************************
...
#define MAX_TOLERANCE_W 0.25                    // 電力測定の許容偏差(W)
#define ALG_MAX_V 14.7                          // 電池の最大電圧(異常検出用)
...
void loop(){                                    // 繰り返し実行する関数
    ...
    switch(btn){
        ...
        case 1: MODE = MODE_MEASURE; break;     // 測定・送信
        case 2: MODE = MODE_STOP; break;        // 停止
